...
#### 1. Enterprises and digitization
...
***1.1 Enterprises which had acquired goods/services in technological areas in the previous three years (2017)***
...
<br><img src="../assets/img/3rd_block/fig_1.svg" width=850px height=650px style="display:block; margin:0 auto"><br>

***1.2 Enterprises indicating the first five technological areas with greater impact on development in the two-year period, by indicated area (2017)***
...
<br><img src="../assets/img/3rd_block/fig_2.svg" width=850px height=550px style="display:block; margin:0 auto"><br>

***1.3 The main digitization factors considered important by enterprises (2018)***
...
<br><img src="../assets/img/3rd_block/fig_3.svg" width=850px height=550px style="display:block; margin:0 auto"><br>

#### 2. Enterprises and innovation
...
***2.1 Enterprises with innovation activities (2016)***

The two choropleth maps above show the number of enterprises with innovation activities by region and the percentage on the total number of enterprises by region respectively. They are complementary visualizations, since even if the first one shows a sharp distinction between the regions, where north and Lombardia in particular are dominant, the second one reveals that if we consider the percentage on the total number of enterprises, the situation is notable uniform. Nevertheless, the difference in quantitative terms is still meaningful.

<br><img src="../assets/img/3rd_block/fig_4.svg" width=850px height=550px style="display:block; margin:0 auto"><br>

***2.2 Innovation expenditure by region (2016)***

The last consideration is supported by this other graph, in which it is shown how much each region spends in innovation (data of year 2016). Indeed, it essentially traces the graph showing the number of enterprises with innovation activities, with the exception of the Lazio region.

<br><img src="../assets/img/3rd_block/fig_5.svg" width=450px height=550px style="display:block; margin:0 auto"><br>

***2.3 Product/process innovation activities and organisation/marketing innovations (2016)***
...
<br><img src="../assets/img/3rd_block/fig_6.svg" width=550px height=500px style="display:block; margin:0 auto"><br> 

#### 3. ICT of the enterprises
...
***3.1 Percentage of enterprises with a website or a homepage (2019)***
...
<br><img src="../assets/img/3rd_block/fig_7.svg" width=550px height=500px style="display:block; margin:0 auto"><br>

***3.2 Enterprises connected via fixed broadband - Download speed (2019)***

<br><img src="../assets/img/3rd_block/fig_8.svg" width=900px height=500px style="display:block; margin:0 auto"><br>

As we can see, the download speed in the three different classes is not so different among the different regions, with an interesting exception of the Calabria regions. It is also worth to mention that from the graph it can be seen that on average about 50% of the enterprises have a fixed broadband connection with a download speed below 30 Mb/s, showing a clear infrastructural problem.